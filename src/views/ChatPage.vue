      ...
      <div class="chat-box">
        ...
        <div class="box-left" :class="{ 'show-left': showLeft }">
          ...
          <div
            ...
            "
          >
            <leechat-avatar :info="{ name: '群' }" size="40px" :color="2" class="mr-[10px]" />
            <div class="chat-item-content">
              ...
              <div v-if="groupChat?.lastMessage" class="chat-content-msg">
                <leechat-chat-list-content :msg="groupChat?.lastMessage" />
              </div>
            </div>
          </div>
          <div
          ...
          <div class="chat-list-content">
            <div
              ...
              "
            >
              <leechat-avatar :info="item.targetInfo" size="40px" class="mr-[10px]" />
              <div class="chat-item-content">
                <div class="flex items-center mb-[5px]">
                ...
                <div class="chat-content-msg">
                  <leechat-chat-list-content :is-group="false" :msg="item?.lastMessage" />
                </div>
              </div>
              <leechat-text-button
        ...
        <div class="box-middle">
          ...
          <div class="middle-content">
            <div class="chat-show-area" ref="chatShowAreaRef">
              ...
              >
                <leechat-msg :msg="item" :user="msgStore.userListMap.get(item.fromId)" />
              </div>
          ...
          <div class="right-top">
            ...
            <div class="flex">
              ...
              <leechat-icon-button
                ...
                icon="icon-yueliang"
              />
              <leechat-icon-button @click="handlerLogout" icon="icon-tuichu" />
            </div>
          </div>
...
import LeechatInput from '@/components/LeechatInput.vue'
import { useRouter } from 'vue-router'
import LeechatAvatar from '@/components/LeechatAvatar.vue'
import ChatListApi from '@/api/chatList.js'
import LeechatDotHint from '@/components/LeechatDotHint.vue'
import MessageApi from '@/api/message.js'
import EventBus from '@/utils/eventBus.js'
import UserApi from '@/api/user.js'
import FileApi from '@/api/file.js'
import LeechatTooltip from '@/components/LeechatTooltip.vue'
import ws from '@/utils/ws.js'
import LeechatTextButton from '@/components/LeechatTextButton.vue'
import { useToast } from '@/components/ToastProvider.vue'
import LeechatIconButton from '@/components/LeechatIconButton.vue'
import LeechatMsg from '@/components/Msg/LeechatMsg.vue'
import { useChatMsgStore } from '@/stores/useChatMsgStore.js'
import LeechatChatListContent from '@/components/Msg/LeechatChatListContent.vue'
import { MessageType } from '@/constant/messageType.js'
import { MessageSource } from '@/constant/messageSource.js'
import LeechatMsgInput from '@/components/LeechatMsgInput.vue'
...
import LeechatLoading from '@/components/LeechatLoading.vue'
