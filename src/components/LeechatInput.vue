<template>
  ...
  >
    <div v-if="props.label" class="leechat-input-label" :class="{ readonly: props.readonly }">
      {{ props.label }}
    </div>
    <input
      ref="inputRef"
      ...
      @input="handleInput"
    />
    <div v-if="props.limit" class="leechat-input-limit">
