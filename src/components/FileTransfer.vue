<template>
  <template v-if="visible">
    <leechat-draggable-window v-if="!isReady" :rounded="20" :resize="false">
      <div class="file-answer">
        <div class="answer-content-wrapper">
          <leechat-avatar :info="props.targetInfo" class="mr-[10px]" />
    ...
    </leechat-draggable-window>
    <leechat-draggable-window v-if="isReady" :rounded="10" :resize="false">
      <div class="file-receive">
        <leechat-circle-progress :progress="progress" :size="60" :strokeWidth="6" />
...
import LeechatDraggableWindow from '@/components/LeechatDraggableWindow.vue'
import LeechatAvatar from '@/components/LeechatAvatar.vue'
import LoadingDots from '@/components/LoadingDots.vue'
import LeechatCircleProgress from '@/components/LeechatCircleProgress.vue'
