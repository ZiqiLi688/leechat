  ...
  <div class="msg" :class="{ right: props.right }">
    ...
    <transition name="fade">
      ...
      >
        ...
        <leechat-tooltip v-if="right" content="撤回">
          <leechat-icon-button @click="onRecallMsg" size="24px" font-size="16px" icon="icon-chehui" />
        </leechat-tooltip>
        <leechat-tooltip @click="handlerCopy" content="复制">
          <leechat-icon-button size="24px" font-size="16px" icon="icon-fuzhi" />
        </leechat-tooltip>
      </div>
    </transition>
  </div>
