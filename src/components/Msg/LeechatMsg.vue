      ...
      <div class="msg-box-info">
        ...
        <div class="mgs-box-user-info" :class="{ right: right }">
          ...
          <div v-for="(item, index) in props.user.badge" :key="index" class="flex">
            <leechat-tooltip :content="badges[item].des">
              <img
                class="mr-[1px] ml-[1px]"
                width="22px"
                height="22px"
        ...
        <!--消息内容-->
        <leechat-msg-content :right="right" :msg="props.msg" />
        <!--引用信息-->
        <div class="msg-box-info-reference" v-if="props.msg.referenceMsg" :class="{ right: right }">
          <leechat-reference-content :msg="props.msg.referenceMsg" />
...
<script setup>
import LeechatMsgContent from '@/components/Msg/LeechatMsgContent.vue'
import LeechatAvatar from '@/components/LeechatAvatar.vue'
import RecallMsg from '@/components/Msg/MsgContent/RecallMsg.vue'
import LeechatReferenceContent from '@/components/Msg/LeechatReferenceContent.vue'
